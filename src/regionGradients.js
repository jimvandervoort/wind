export const regionGradients = {
  tarifa: 'bg-gradient-to-br from-amber-500 to-yellow-500',
  ...
  germany: 'bg-gradient-to-br from-rose-500 to-orange-500',
  myspots: 'bg-gradient-to-tl from-purple-400 to-indigo-500',
};
